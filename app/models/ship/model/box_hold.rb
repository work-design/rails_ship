module Ship
  module Model::BoxHold
    ...
    included do
      ...
      has_many :box_entrusts, ->(o) { where(organ_id: o.organ_id, user_id: o.user_id, member_id: o.member_id) }, primary_key: :box_specification_id, foreign_key: :box_specification_id
      ...
      has_many :items, ->(o) { where(organ_id: o.organ_id, good_type: 'Ship::BoxSale', good_id: o.box_sale&.id, member_id: o.member_id) }, class_name: 'Trade::Item', primary_key: :user_id, foreign_key: :user_id
    end
