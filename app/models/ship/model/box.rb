module Ship
  module Model::Box
    ...
    included do
      ...
      belongs_to :box_hold, ->(o) { where(organ_id: o.organ_id, user_id: o.owned_user_id) }, foreign_key: :box_specification_id, primary_key: :box_specification_id, counter_cache: true, optional: true
