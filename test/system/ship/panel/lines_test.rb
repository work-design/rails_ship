...
class LinesTest < ApplicationSystemTestCase
  setup do
    @ship_panel_line = ship_panel_lines(:one)
  end

  test "visiting the index" do
    visit ship_panel_lines_url
  ...
  test "creating a Line" do
    ...
    fill_in "Finish name", with: @ship_panel_line.finish_name
    fill_in "Name", with: @ship_panel_line.name
    fill_in "Start name", with: @ship_panel_line.start_name
