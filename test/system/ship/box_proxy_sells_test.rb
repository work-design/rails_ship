...
class BoxProxySellsTest < ApplicationSystemTestCase
  setup do
    @ship_box_proxy_sell = ship_box_proxy_sells(:one)
  end

  test "visiting the index" do
    visit ship_box_proxy_sells_url
  ...
  test "should create box proxy sell" do
    ...
    fill_in "Price", with: @ship_box_proxy_sell.price
    fill_in "Sellable count", with: @ship_box_proxy_sell.sellable_count
  ...
  test "should update Box proxy sell" do
    visit ship_box_proxy_sell_url(@ship_box_proxy_sell)
